...
public class ApartmentBuilding extends House{
    ...
    public void init(Scanner scanner){
        ...
        System.out.println("Кол-во жильцов:");
        this.tenants = scanner.nextLine();
    }
    ...
    public String toString(){
        ...
        return ("Вид здания: " + this.type + " Кол-во этажей " + this.floor + " Цена постройки: " + this.cost + "Материал:" + this.materials + " Кол-во жильцов: " + this.tenants);
    }
}
